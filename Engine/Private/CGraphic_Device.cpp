...
HRESULT CGraphic_Device::Initialize(HWND hWnd, WINMODE eWinMode, uint32 winSizeX, uint32 winSizeY,
...
HRESULT CGraphic_Device::Ready_SwapChain(HWND hWnd, WINMODE eWinMode, uint32 winSizeX, uint32 winSizeY)
{
...
HRESULT CGraphic_Device::Ready_DepthStencilView(uint32 winSizeX, uint32 winSizeY)
{
    if (_device == nullptr)
        return E_FAIL;
...
unique_ptr<CGraphic_Device> CGraphic_Device::Create(HWND hWnd, WINMODE eWinMode, uint32 winSizeX, uint32 winSizeY,
    ComPtr<Device>& deviceOut, ComPtr<DeviceContext>& contextOut)
{
    auto instance = make_unique<CGraphic_Device>();
