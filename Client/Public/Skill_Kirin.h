...
class Skill_Kirin : public SkillObject
{
    GENERATED_BODY(Skill_Kirin)

public:
    explicit Skill_Kirin(ComPtr<Device> device, ComPtr<DeviceContext> context);
    explicit Skill_Kirin(const Skill_Kirin& rhs);
    virtual ~Skill_Kirin() = default;
